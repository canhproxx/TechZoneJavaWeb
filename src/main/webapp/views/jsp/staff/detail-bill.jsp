...
<body>
	...
	<div id="content" class="container">
		<h2>Bill Detail Of Customer</h2>

		<button id="btn-back" type="button" onclick="goBack()" class="btn btn-dark">Back</button>
		<script>
			function goBack() {
				window.history.go(-1);
			}
			...
			<tbody>
				...
				<c:forEach var="tempBillDetail" items="${theBillDetails}">
					<tr>
						...
						<td class="image">
								<img 
									src="${pageContext.request.contextPath}/resources/images/${tempBillDetail.product.productDetail.image}"
									alt="Photo">
						</td>
					</tr>
				</c:forEach>
